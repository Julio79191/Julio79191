...
- 🎮 Jogar (principalmente FPS e atualmente um pouquinho de corrida);
- 🏐 Esportes (por mais que não pratique mais com tanta frequencia gosto de esportes no geral);
...
### Atualmente:
- 🤔 Não possuo um trabalho;
- 📚 Estou no ultimo semestre de Gestão da Tecnologia da Informação;
- 👩‍💻 Estou fazendo cursos para expandir meu curriculo, finalizar a faculdade e deixar aqui bonitinho 😝;
